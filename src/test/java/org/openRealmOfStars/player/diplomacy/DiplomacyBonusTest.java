...
public class DiplomacyBonusTest {
  ...
  public void testHuman() {
    ...
    int[] bonusValues =  {-30,  -8,  12,  25,  -5,  -2,   3,  -5,  5,   5,  5, -3, -6, 0, 30, -4,
        10, 2, 4, 0, -5, 4, -4, 0, 10, -7, 8, 3, 3, 10, -10, -12, -4, -2};
    int[] bonusLasting = {255, 150, 255, 255, 200,  20,  50, 80, 110, 255, 1, 70, 120, 10, 255, 30,
        20, 255, 255, 255, 20, 60, 60, 255, 110, 100, 110, 40, 40, 100, 100, 255, 60, 60};
  ...
  public void testCentaurs() {
    ...
    int[] bonusValues =  {-30,  -8,  12,  25,  -8,  -2,   2,  -5,  4,   5,  5, -3, -8, 0, 25, -4,
        10, -1, 3, 0, -5, 4, -4, 0, 7, -7, 6, 3, 3, 8, -8, -12, -4, -2};
    ...
    int[] bonusLasting2 = {255, 149, 255, 255, 199,  19,  49, 79, 99, 255, 2, 69, 119, 9, 255, 29,
        19, 255, 255, 255, 19, 59, 59, 255, 99, 99, 99, 39, 39, 99, 99, 255, 59, 59};
    for (int i = 0; i < DiplomacyBonusType.MAX_BONUS_TYPE; i++) {
      DiplomacyBonus bonus = new DiplomacyBonus(
  ...
  public void testGreyans() {
    ...
    int[] bonusValues =  {-40,  -8,  18,  30,  -5,  -2,   2,  -5,  4,   5,  5, -3, -5, 0, 25, -4,
        10, 0, 3, 0, -5, 4, -4, 0, 7, -7, 6, 3, 3, 8, -8, -12, -4, -2};
  ...
  public void testSporks() {
    ...
    int[] bonusValues =  {-30,  -2,  12,  25,  -3,  -1,   2,  -10,  4,   2,  1, -2, -4, 0, 20, -2,
        13, -3, 3, 0, -8, 2, -2, 0, 10, -10, 6, 3, 3, 8, -4, -12, -4, -2};
    int[] bonusLasting = {255, 100, 255, 255, 200,  10,  50, 150, 100, 255, 1, 60, 100, 10, 255, 20,
        20, 255, 255, 255, 20, 60, 60, 255, 110, 110, 100, 40, 40, 100, 100, 255, 60, 60};
    for (int i = 0; i < DiplomacyBonusType.MAX_BONUS_TYPE; i++) {
      DiplomacyBonus bonus = new DiplomacyBonus(
  ...
  public void testMechions() {
    ...
    int[] bonusValues =  {-30,  -8,  12,  25,  -5,  -3,   2,  -5,  4,  -3,  5, -1, -3, 0, 25, -6,
        8, -2, 3, 0, -5, 2, -2, 0, 5, -5, 4, 3, 3, 6, -6, -12, -4, -2};
    int[] bonusLasting = {255, 150, 255, 255, 200,  10,  50, 80, 100, 255, 1, 20, 80, 10, 255, 20,
        20, 255, 255, 255, 20, 60, 60, 255, 90, 90, 90, 40, 40, 100, 100, 255, 60, 60};
    for (int i = 0; i < DiplomacyBonusType.MAX_BONUS_TYPE; i++) {
      DiplomacyBonus bonus = new DiplomacyBonus(
  ...
  public void testMothoids() {
    ...
    int[] bonusValues =  {-30,  -8,  12,  25,  -5,  -2,   2,  -5,  4,   5,  8, -3, -5, 0, 25, -4,
        10, 0, 3, 0, -5, 2, -2, 0, 7, -7, 6, 3, 3, 8, -8, -12, -4, -2};
    int[] bonusLasting = {255, 150, 255, 255, 200,  20,  50, 80, 100, 255, 1, 70, 100, 10, 255, 30,
        20, 255, 255, 255, 20, 60, 60, 255, 100, 100, 100, 40, 40, 100, 100, 255, 60, 60};
    for (int i = 0; i < DiplomacyBonusType.MAX_BONUS_TYPE; i++) {
      DiplomacyBonus bonus = new DiplomacyBonus(
  ...
  public void testTeuthidaes() {
    ...
    int[] bonusValues =  {-30,  -8,  12,  25,  -5,  -2,   2,  -5,  4,   -3,  5, -3, -6, 0, 20, -2,
        15, -2, 3, 0, -5, 2, -2, 0, 7, -7, 6, 3, 3, 8, -8, -12, -4, -2};
  ...
  public void testScaurians() {
    ...
    int[] bonusValues =  {-30,  -8,  18,  25,  -5,  -1,   3,  -5,  5,   5,  6, -3, -4, 0, 25, -4,
        10, 1, 6, 0, -8, 4, -4, 0, 7, -7, 6, 3, 3, 8, -8, -12, -4, -2};
  ...
  public void testChiraloids() {
    ...
    int[] bonusValues =  {-30,  -8,  12,  25,  -5,  -2,   2,  -5,  4,   5,  5, -2, 2, 0, 25, -2,
        12, -4, 3, 0, -8, 2, -2, 0, 7, -7, 6, 3, 3, 8, -8, -12, -4, -2};
