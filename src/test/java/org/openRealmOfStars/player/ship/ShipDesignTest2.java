...
public class ShipDesignTest2 {
	...
	/**
	 * addComponentTest
	 * purpose : Make sure Component ADD
	 * input : 
	 * 				ShipComponent weapon
	 * Expected : 
	 * 				ShipDesign.getComponent(0) == weapon
	 */
	@Test
	...
	/**
	 * getNumberOfComponentTest
	 * purpose : Make sure getNumber of Component 
	 * input : 
	 * 				ShipComponent weapon
	 * Expected : 
	 * 				ShipDesign.getNumberOfComponents() == 1
	 */
	@Test
	...
	/**
	 *  getComponetTest
	 * 	purpose : Make sure getComponent is equal to added component
	 *	input : 
	 *				getComponent NUll index
	 *				getComponent INVLID index
	 *				ShipComponent weapon
	 *	expected :
	 *				ShipDesign.getComponnet(-1) == NULL
	 *				ShipDesign.getComponnet(0) == NULL
	 *				ShipDesign.getComponent(0) == weapon				
	 */
	@Test 
	...
	/**
	 * removeComponentTest
	 * purpose : Make sure removeCompoennt is executed
	 * input : 
	 * 				ShipComponent weapon
	 * expected :
	 * 				ShipDesign.getComponent(0) == NULL 
	 */
	@Test
	...
	/**
	 * getName,setName,gethullTest
	 * purpose : Make sure getName,SetName,gethul; is executed
	 * input : 
	 * 				Initiative name "Design"
	 * 				SetName "TestDesign"
	 * 				ShipHull shiphull	 
	 * expected :
	 * 				ShipDesign.getName == "Design"
	 * 				ShipDesign.getName == "TestDesign"
	 * 				ShipDesign.getHull == shiphull
	 */
	@Test
	...
	/**
	 * getFreeEnergyTest
	 * purpose : Make sure getFreeEnery is executed
	 * input : 
	 * 				ShipCompoennt weapon ( WEAPON_ENERGY_REQUIREMENT is 1 )
	 * 				ShipCompoennt engine ( ENGINE_ENERGY_RESOURCE is 1 )
	 * expected :
	 * 				ShipDesign.getFreeEnergy() is -1;
	 * 				ShipDesign.getFreeEnergy() is 0;
	 */
	@Test
	...
	/** 
	 * getTotalShieldTest
	 * purpose : Make Sure getTotal is executed
	 * input : 
	 * 				ShipComponent shield ( SHIELD_VALUE is 1 )
	 * expected : 
	...
	/** 
	 * gotCertainTypeTest
	 * purpose : Make sure getCertainType is executed
	 * input : 
	 * 				ShipComponent shield ( TYPE is SHIELD )
	 * expected :
	...
	/** 
	 * getTotalArmorTest
	 * purpose : Make sure getTotalArmorTest is executed
	 * input : 
	 * 				ShipComponent armor ( ARMOR_VALUE is 1 )
	 * expected :
	...
	/** 
	 * hasWeaponsTest
	 * purpose : Make sure hasWeapon is executed
	 * input : 
	 * 				ShipComponent weapon ( ShipComponentType.WEAPON_BEAM )
	 * 				ShipComponent weapon2 ( ShipComponentType.WEAPON_ECM_TORPEDO )
	 *  			ShipComponent weapon3 ( ShipComponentType.WEAPON_HE_MISSILE )
	 *  			ShipComponent weapon4 ( ShipComponentType.WEAPON_PHOTON_TORPEDO )
	 *  			ShipComponent weapon5 ( ShipComponentType.WEAPON_RAILGUN )
	 * 
	 * expected :
	 * 				ShipDesign.hasWeapons() == true
	 */
	@Test
	...
	/** 
	 * hasEngineTest
	 * purpose : Make sure hasEngine is executed
	 * input : 
	 * 				ShipComponent weapon ( ShipComponentType.ENGINE )
	 * expected :
	...
	/** 
	 * getFreeSlotsTest
	 * purpose : Make sure getFreeSlots is executed
	 * input : 
	 * 				ShipComponent shipcomponent1,shipcomponent2
	 * expected :
	...
	/** 
	 * getCostTest
	 * purpose : Make sure getCost is executed
	 * input : 
	 * 				ShipHull shiphull ( HULL_COST is 1 )
	 * 				ShipComponent weapon ( WEAPON_COST is 5 )
	 * 				ShipComponent engine ( ENGINE_COST is 5 )
	 * expected :
	 * 				ShipDesign.getCost == TOTAL_COST ( 16 )
	 */
	@Test
	...
	/** 
	 * getMetalCostTest
	 * purpose : Make sure getMetalCost is executed
	 * input : 
	 * 				ShipHull shiphull ( HULL_METAL_COST is 1 )
	 * 				ShipComponent weapon ( WEAPON_METAL_COST is 5 )
	 * 				ShipComponent engine ( ENGINE_METAL_COST is 5 )
	 * expected :
	 * 				ShipDesign.getMetalCost() == TOTAL_METAL_COST ( 6 )
	 */
	@Test
	...
	/** 
	 * getTotalMilitaryPowerTest
	 * purpose : Make sure getTotalMilitaryPower is executed
	 * input : 
	 * 				ShipHull shiphull ( SLUT_HULL is 5 )
	 * 				ShipComponent weaponBeam ( WEAPON_BEAM_POWER is 2 )
	 * 				ShipComponent weaponEcmTorpedo ( WEAPON_ECM_TORPEDO_POWER is 4 )
	 * 				ShipComponent shield ( SHIELD_VALUE is 2 )
	 * 				ShipComponent armor ( ARMOR_VALUE is 4 )
	 * 				ShipComponent engine ( ENGINE_VALUE is 2 )
	 * 				ShipComponent targettingComputer ( TARGETING_COMPUTER_VALUE is 10 )
	 * 				ShipComponent jammer ( JAMMER_VALUE is 10 )   
	 * expected :
	 * 				ShipDesign.getTotalMilitaryPower() == TOTAL_POWER ( 41 )
	 */
	@Test
	public void getTotalMilitaryPowerTest(){
		...
		final int TOTAL_POWER = SLUT_HULL*7+WEAPON_BEAM_POWER+WEAPON_ECM_TORPEDO_POWER/2+
				SHIELD_VALUE+ARMOR_VALUE+(ENGINE_VALUE-1)+TARGETING_COMPUTER_VALUE/10+JAMMER_VALUE/10;
	...
	/** 
	 * getTotalTrooperPowerTest
	 * purpose : Make sure getTotalTrooperPower is executed
	 * input : 
	 * 				ShipHull shiphull ( SLUT_HULL is 5 , MAX_SLOT is 10)
	...
	/** 
	 * getComponentListTest
	 * purpose : Make sure getComponentList is executed
	 * input : 
	 * 				ShipComponent[] testResult ( engine,shield,armor)
	 * expected :
	...
	/** 
	 * changePriorityTest
	 * purpose : Make sure changePriority is executed
	 * input : 
	 * 				UNVALID_INDEX is 3
	 * 				TEST_INDEX is 1
	 * 				ShipComponent engine
	 * 				ShipComponent shield
	 * 				ShipComponent armor
	 * expected :
	 * 				ShipDesign.changePriority( UNVALID_INDEX, true ) == UNVALID_INDEX (3)
	 * 				ShipDesign.changePriority( TEST_INDEX, true ) == 0
	 * 				ShipDesign.changePriority( TEST_INDEX, false ) == 2
	 */
	@Test
