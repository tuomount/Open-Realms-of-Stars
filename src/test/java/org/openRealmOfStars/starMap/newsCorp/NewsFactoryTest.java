...
public class NewsFactoryTest {
  ...
  public void testDeadlyVirus() {
    ...
    NewsData news = NewsFactory.makeDeadlyVirusNews(planet, null, 2642);
    ...
    news = NewsFactory.makeDeadlyVirusNews(planet, spreader, -1);
    assertEquals(true, news.getNewsText().contains("deadly virus"));
    assertEquals(true, news.getNewsText().contains("Alpha Test I"));
    ...
    news = NewsFactory.makeDeadlyVirusNews(planet, spreader, 2323);
    assertEquals(true, news.getNewsText().contains("deadly virus"));
    assertEquals(true, news.getNewsText().contains("Alpha Test I"));
    assertEquals(true, news.getNewsText().contains(spreader.getEmpireName()));
    assertEquals(true, news.getNewsText().contains(owner.getEmpireName()));
  ...
  public void testCultureVictory() {
    ...
    Mockito.when(diplomacy.isTradeAlliance(1)).thenReturn(false);
    Mockito.when(diplomacy.isTradeAlliance(2)).thenReturn(true);
    Mockito.when(diplomacy.isTradeAlliance(3)).thenReturn(false);
    PlayerInfo info = Mockito.mock(PlayerInfo.class);
    ...
    Mockito.when(diplomacy1.getAllianceIndex()).thenReturn(-1);
    Mockito.when(diplomacy1.isTradeAlliance(0)).thenReturn(false);
    Mockito.when(diplomacy1.isTradeAlliance(1)).thenReturn(false);
    Mockito.when(diplomacy1.isTradeAlliance(2)).thenReturn(true);
    Mockito.when(diplomacy1.isTradeAlliance(3)).thenReturn(false);
    Mockito.when(info2.getDiplomacy()).thenReturn(diplomacy1);
    ...
    Mockito.when(diplomacy2.isTradeAlliance(0)).thenReturn(true);
    Mockito.when(diplomacy2.isTradeAlliance(1)).thenReturn(true);
    ...
    Mockito.when(diplomacy3.isTradeAlliance(0)).thenReturn(false);
    Mockito.when(diplomacy3.isTradeAlliance(1)).thenReturn(false);
    Mockito.when(diplomacy3.isTradeAlliance(2)).thenReturn(true);
    Mockito.when(diplomacy3.isTradeAlliance(3)).thenReturn(false);
  ...
  public void testCultureVictoryDisabled() {
    ...
    Mockito.when(diplomacy1.isTradeAlliance(2)).thenReturn(true);
    Mockito.when(diplomacy1.isTradeAlliance(3)).thenReturn(false);
    Mockito.when(info.getDiplomacy()).thenReturn(diplomacy1);
    PlayerInfo info2 = Mockito.mock(PlayerInfo.class);
    Mockito.when(info2.getEmpireName()).thenReturn("Empire II");
    Mockito.when(info2.getFleets()).thenReturn(fleetList);
    Diplomacy diplomacy2 = Mockito.mock(Diplomacy.class);
  ...
  public void testCultureVictoryAlliance() {
    ...
    Mockito.when(diplomacy.isTradeAlliance(0)).thenReturn(false);
    Mockito.when(diplomacy.isTradeAlliance(1)).thenReturn(true);
    Mockito.when(diplomacy.isTradeAlliance(2)).thenReturn(false);
    Mockito.when(diplomacy.isTradeAlliance(3)).thenReturn(false);
    Diplomacy diplomacy2 = Mockito.mock(Diplomacy.class);
    Mockito.when(diplomacy2.getAllianceIndex()).thenReturn(0);
    Mockito.when(diplomacy2.isTradeAlliance(0)).thenReturn(true);
    Mockito.when(diplomacy2.isTradeAlliance(1)).thenReturn(false);
    Mockito.when(diplomacy2.isTradeAlliance(2)).thenReturn(false);
    Mockito.when(diplomacy2.isTradeAlliance(3)).thenReturn(false);
    Diplomacy diplomacy3 = Mockito.mock(Diplomacy.class);
    Mockito.when(diplomacy3.getAllianceIndex()).thenReturn(-1);
    Mockito.when(diplomacy3.isTradeAlliance(0)).thenReturn(true);
    Mockito.when(diplomacy3.isTradeAlliance(1)).thenReturn(true);
    Mockito.when(diplomacy3.isTradeAlliance(2)).thenReturn(false);
    Mockito.when(diplomacy3.isTradeAlliance(3)).thenReturn(true);
    Diplomacy diplomacy4 = Mockito.mock(Diplomacy.class);
    Mockito.when(diplomacy4.getAllianceIndex()).thenReturn(-1);
    Mockito.when(diplomacy4.isTradeAlliance(0)).thenReturn(true);
    Mockito.when(diplomacy4.isTradeAlliance(1)).thenReturn(true);
    Mockito.when(diplomacy4.isTradeAlliance(2)).thenReturn(true);
    Mockito.when(diplomacy4.isTradeAlliance(3)).thenReturn(false);
    PlayerInfo info = Mockito.mock(PlayerInfo.class);
    Mockito.when(info.getEmpireName()).thenReturn("Empire I");
    Mockito.when(info.getFleets()).thenReturn(fleetList);
    Mockito.when(info.getDiplomacy()).thenReturn(diplomacy);
  ...
  @Test
  @Category(org.openRealmOfStars.UnitTest.class)
  public void testPopulationVictory() {
    StarMap map = Mockito.mock(StarMap.class);
    Mockito.when(map.getScorePopulation()).thenReturn(2);
    Mockito.when(map.getTurn()).thenReturn(182);
    PlayerList playerList = Mockito.mock(PlayerList.class);
    Mockito.when(playerList.getCurrentMaxPlayers()).thenReturn(4);
    Mockito.when(playerList.getCurrentMaxRealms()).thenReturn(4);
    PlayerInfo winner = Mockito.mock(PlayerInfo.class);
    ...
    Mockito.when(playerList.getPlayerInfoByIndex(2)).thenReturn(winner);
    Mockito.when(playerList.getPlayerInfoByIndex(3)).thenReturn(second);
    ArrayList<Planet> planets = new ArrayList<>();
    Planet planet1 = Mockito.mock(Planet.class);
    Mockito.when(planet1.getTotalPopulation()).thenReturn(15);
    Mockito.when(planet1.getPlanetPlayerInfo()).thenReturn(winner);
    Mockito.when(planet1.getPlanetOwnerIndex()).thenReturn(2);
    planets.add(planet1);
    Planet planet2 = Mockito.mock(Planet.class);
    Mockito.when(planet2.getTotalPopulation()).thenReturn(2);
    Mockito.when(planet2.getPlanetPlayerInfo()).thenReturn(second);
    Mockito.when(planet2.getPlanetOwnerIndex()).thenReturn(3);
    planets.add(planet2);
    Mockito.when(map.getPlanetList()).thenReturn(planets);
    NewsData news = NewsFactory.makePopulationVictoryNewsAtEnd(map);
    assertNotNull(news);
    assertEquals(true, news.getNewsText().contains("Empire of Homarian"));
  }
  ...
  @Test
  @Category(org.openRealmOfStars.UnitTest.class)
  public void testPopulationVictoryAlliance() {
    StarMap map = Mockito.mock(StarMap.class);
    Mockito.when(map.getScorePopulation()).thenReturn(2);
    Mockito.when(map.getTurn()).thenReturn(182);
    PlayerList playerList = Mockito.mock(PlayerList.class);
    ...
    assertNotNull(news);
    assertEquals(true, news.getNewsText().contains("Empire of Homarian"));
    assertEquals(true, news.getNewsText().contains("Empire of Humans"));
  }
