...
public class StarMapTest {
  ...
  public void testMilitaryEstimation() {
    ...
    espionage.getByIndex(2).setIntelligenceLevel1Estimate(40);
    espionage.getByIndex(2).setIntelligenceLevel3Estimate(-30);
    espionage.getByIndex(2).setIntelligenceLevel5Estimate(20);
    espionage.getByIndex(2).setIntelligenceLevel7Estimate(-10);
    ...
    Mockito.when(info2.getIntelligence()).thenReturn(espionage);
    Diplomacy diplomacy = Mockito.mock(Diplomacy.class);
    ...
    espionage.getByIndex(2).addIntelligenceBonus(IntelligenceBonusType.SPY_FLEET, 1, "Test");
    diff = map.getMilitaryDifference(0, 2);
    assertEquals(-44, diff);
    espionage.getByIndex(2).addIntelligenceBonus(IntelligenceBonusType.SPY_FLEET, 2, "Test");
    diff = map.getMilitaryDifference(0, 2);
  ...
  public void testDefensivePactEstimation() {
    ...
    espionage.getByIndex(2).setIntelligenceLevel5Estimate(20);
    espionage.getByIndex(2).setIntelligenceLevel7Estimate(-10);
    espionage.getByIndex(3).setIntelligenceLevel1Estimate(35);
    espionage.getByIndex(3).setIntelligenceLevel3Estimate(25);
    espionage.getByIndex(3).setIntelligenceLevel5Estimate(-15);
    espionage.getByIndex(3).setIntelligenceLevel7Estimate(-8);
    Diplomacy diplomacy = Mockito.mock(Diplomacy.class);
    ...
    espionage.getByIndex(2).addIntelligenceBonus(IntelligenceBonusType.SPY_FLEET, 1, "Test");
    espionage.getByIndex(3).addIntelligenceBonus(IntelligenceBonusType.SPY_FLEET, 1, "Test");
    assertEquals(131, map.getMilitaryEstimationForDefensivePact(0, 2, false));
    assertEquals(-107, map.getMilitaryDifference(0, 2));
    espionage.getByIndex(2).addIntelligenceBonus(IntelligenceBonusType.SPY_FLEET, 2, "Test");
    espionage.getByIndex(3).addIntelligenceBonus(IntelligenceBonusType.SPY_FLEET, 2, "Test");
