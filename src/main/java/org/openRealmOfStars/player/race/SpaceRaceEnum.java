...
public enum SpaceRaceEnum {
   ...
   */
  SpaceRaceEnum(final int index, final String name, final String single,
   ...
   */
  public static SpaceRaceEnum getRandomLivingRace() {
    var nonRoboticRaces = Stream.of(values())
        .filter(race -> !race.isRoboticRace())
        // Filter out "pseudo-races"
        .filter(
            race -> race != SPACE_PIRATE
            && race != SpaceRaceEnum.SPACE_MONSTERS)
   ...
   */
  public static SpaceRaceEnum getRandomRoboticRace() {
