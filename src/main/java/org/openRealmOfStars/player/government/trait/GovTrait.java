...
/**
 * Represents a trait that government may have.
 *
 * <p>
 * Traits are not stackable and should be considered being "flags".
 * Government can have only one trait with given ID.
 * </p>
 * <p>
 * GovTrait must have unique ID. It must have a name
...
public final class GovTrait {
   ...
   */
  GovTrait(final String id, final String name, final String description,
  ...
  /**
   * Check if GovTrait conflicts with other GovTraits.
